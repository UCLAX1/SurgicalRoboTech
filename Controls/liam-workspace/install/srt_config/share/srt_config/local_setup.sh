...
: ${AMENT_CURRENT_PREFIX:="/home/parallels/liam-workspace/install/srt_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/srt_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/srt_config/environment/path.sh"
